...
lazy_static! {
    static ref MAPPED_ENTITIES: BiMap<&'static str, EntityType> = {
        ...
        m.insert("cave_spider", EntityType::CaveSpider);
        ...
        m.insert("piglin", EntityType::Piglin);
        ...
        m.insert("zombified_piglin", EntityType::ZombifiedPiglin);
