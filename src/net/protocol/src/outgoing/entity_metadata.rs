...
pub mod constructors {
    use super::*;
    use crate::outgoing::entity_metadata::entity_state::{EntityState, EntityStateMask};
    use crate::outgoing::entity_metadata::extra_data_types::EntityPose;
...
mod value {
    use super::*;
    use crate::outgoing::entity_metadata::entity_state::EntityStateMask;
    use crate::outgoing::entity_metadata::extra_data_types::EntityPose;
